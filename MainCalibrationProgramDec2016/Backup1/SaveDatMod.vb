                    ...
                    For Fish = 1 To NumFish
                        ...
                        For Age = 2 To MaxAge
                            ...
                            If CWTAll(STk, Age, FishNum, outstep) > 0 Or ShakerAll(STk, Age, FishNum, outstep) > 0 Then
                                ...
                                If LegalProp > 0 And CWTAll(STk, Age, FishNum, outstep) > 0 Then
                                    If TermFlag(FishNum, outstep) = PTerm Then
                                        ExRateAll(STk, Age, Fish, outstep) = EscExpFact(STk) * CWTAll(STk, Age, FishNum, outstep) / (CohortAll(STk, Age, PTerm, outstep) * LegalProp)
                                    Else
                                        ExRateAll(STk, Age, Fish, outstep) = EscExpFact(STk) * CWTAll(STk, Age, FishNum, outstep) / (CohortAll(STk, Age, Term, outstep) * LegalProp)
                                    End If
                                End If
                            ...
                            If ShakerAll(STk, Age, FishNum, outstep) > 0 Then
                                If STk = 24 And Age = 2 And Fish = 1 And TStep = 1 Then
                                    TStep = 1
                                End If
