                    ...
                    For Fish = 1 To NumFish - 1
                        For STk = MinStk To NumStk
                            For Age = 2 To MaxAge
                                ...
                                '    Print(3, STk & "," & Age & "," & Fish & "," & TStep & "," & FishExpCWTAll(STk, Age, Fish, TStep) & "," & TotExpCWTAll(STk, Age, Fish, TStep) & vbCrLf)
                                'End If
