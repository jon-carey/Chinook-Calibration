            ...
            If TotEnc > 0 Then
                For STk = MinStk To MaxStk
                    ...
                    If StockCatchProp(STk, Fish) > 0 Then ' catch of this stock in this fishery = 1 for OOB
                        TotSubLegalPop = 0
                        'this code is not following the method outline in "Cohort Analysis Example". Method questionable because sublegal 
                        'encounters don't change during iterations (only age comp of encounters) and sublegal encounters are not a function of
                        'encounter rate adjustment factors (sulegal pop/legal pop)
                        ...
                        For Age = 2 To MaxAge
                            ...
                            If SumSublegalStock > 0 Then
                                ...
                                If ShakerAll(STk, Age, Fish, TStep) > 0 Then
                                    Print(22, STk & "," & Age & "," & Fish & "," & TStep & "," & "," & ShakerAll(STk, Age, Fish, TStep) / ShakMortRate(Fish, TStep) & "," & "SublegalEncounters" & vbCrLf)
                                End If
